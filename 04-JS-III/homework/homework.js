...
function mesesDelAño(array) {
  ...
  // Tu código:
  let base = ["Enero", "Marzo", "Noviembre"]
  let res = []
  array.forEach(e => {
    base.forEach(b => {
      if(e === b) res.push(e)
  ...
  if(res.length !== 3) res = 'No se encontraron los meses pedidos'
  return res
}
...
function mayorACien(array) {
  ...
  array.forEach(element => {
    if(element > 100) res.push(element)
  });
  return res;
}
